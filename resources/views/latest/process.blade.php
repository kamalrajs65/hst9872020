...
<div class="container">
  <div class="row">
    <div class="col-lg-12">
      <h3 class="text-center">From ideation to outcome and beyond!</h3> <br>
      ...
      <ul class="timeline">
        <li>
          ...
          <div class="timeline-panel">
            ...
            <div class="timeline-body">
              <p class="text-muted">
              Every app begins with an idea that goes through an extensive research on markets, demographics, and a lot of other things.  </p>
            </div>
          </div>
          <div class="line"></div>
        </li>
        <li class="timeline-inverted">
          ...
          <div class="timeline-panel">
            ...
            <div class="timeline-body">
              <p class="text-muted">
              Ideas in mind are brought into visuals on paper. A lot of sketching happens in this phase to ensure the flow and features meet the expectations.  </p>
            </div>
          </div>
          <div class="line"></div>
        </li>
